...
public class EquipeController {
    ...
    @PostMapping
    public ResponseEntity<Equipe> create(@RequestBody DadosEquipePost dados) {
        Equipe equipe = new Equipe(null, dados.nome(), dados.descricao(), new ArrayList<>());
    ...
    @PutMapping("/{id}")
    @Transactional
    public ResponseEntity<String> update(@PathVariable Long id, @RequestBody DadosEquipePut dados) {
